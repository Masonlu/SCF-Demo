...
Page({
    ...
    onLoad() {
        this.collection = wx.cloud.database().collection('album')
      ...
      wx.chooseImage({
            ...
            success: (res) => {
                ...
                return wx.cloud.uploadFile({
                    cloudPath: (new Date()).valueOf() + /\.[^\.]+$/.exec(res.tempFilePaths[0])[0],
    ...
    downloadImage() {
        ...
        wx.cloud.downloadFile({
            fileID: this.data.imageInAction,
        // wx.downloadFile({
    ...
    deleteImage() {
        ...
        return wx.cloud.deleteFile({
            ...
            return this.collection.where({
                ...
                return this.collection.doc(res.data[0]._id).remove().then(() => {
                    return {code: 0}
                })
            })
        })
